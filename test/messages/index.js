...
describe('Messages', function() {
  ...
  describe('@constructor', function() {
    it('sets properties correctly', function() {
      var network = orecore.Networks.defaultNetwork;
      var messages = new Messages({
        network: network,
        Block: orecore.Block,
      ...
      messages.builder.constructors.Block.should.equal(orecore.Block);
      messages.builder.constructors.Transaction.should.equal(orecore.Transaction);
    ...
    it('network should be unique for each set of messages', function() {
      ...
      messages.network.should.deep.equal(orecore.Networks.livenet);
      messages2.network.should.deep.equal(orecore.Networks.testnet);
      var message1 = messages.Version();
      message1.network.should.deep.equal(orecore.Networks.livenet);
      var message2 = messages2.Version();
      message2.network.should.deep.equal(orecore.Networks.testnet);
    });
  });
  ...
  describe('Default Network', function() {
    ...
    Object.keys(messages.builder.commandsMap).forEach(function(command) {
      ...
      it(name, function() {
        var message = messages[name]();
        message.network.should.deep.equal(orecore.Networks.defaultNetwork);
      });
    });
  ...
  describe('#parseBuffer', function() {
    it('fails with invalid command', function() {
      var invalidCommand = 'b1ded0af6d616c6963696f757300000025000000bd5e830c' +
    ...
    it('ignores malformed messages', function() {
      ...
      var malformed2 = 'b1ded0af67657464617461000000000089000000d88134740102' +
        '0000006308e4a380c949dbad182747b0f7b6a89e874328ca41f37287f74a81b8f84' +
        '86d';
      var malformed3 = 'b1ded0af67657464617461000000000025000000616263640102' +
