 ...
 * using the standard Galactrum protocol. A Peer instance represents one connection
 * on the Galactrum network. To create a new peer connection provide the host and port
