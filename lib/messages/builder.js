...
function builder(options) {
  ...
  if (!options.network) {
    options.network = orecore.Networks.defaultNetwork;
  }

  options.Block = options.Block || orecore.Block;
  options.BlockHeader = options.BlockHeader || orecore.BlockHeader;
  options.Transaction = options.Transaction || orecore.Transaction;
  options.MerkleBlock = options.MerkleBlock || orecore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || orecore.MnListDiff;
